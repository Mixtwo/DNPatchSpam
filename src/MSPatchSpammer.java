...
public class MSPatchSpammer {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for(int i = 0; i < lastThreeDigits.size(); i++){
            final URL url2 = new URL("http://maplestory.nexon.net/news/updates/update-notes/00"+lastThreeDigits.get(i));
    ...
    public static void checkIfValidURL(final URL url)
            throws MalformedURLException, IOException
    {
        final URL DEFAULT_URL = new URL("http://maplestory.nexon.net/micro-site/beasttamer");
        ...
        if (huc.getURL().equals(DEFAULT_URL) || huc.getURL().toString().startsWith("http://maplestory.nexon.net/Error/") || huc.getURL().toString().contains(">") || huc.getURL().toString().contains("<")) {
